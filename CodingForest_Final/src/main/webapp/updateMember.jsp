...
<hr style="background-color:#369F36;">
	...
	<c:set var="day" value="${birth.split('/')[2]}" />
		...
		<form name="newMember" class="form-horizontal"
			...
			<div class="form-group row">
				<label class="col-sm-2"style="font-family: 'Bebas Neue', cursive;color:#369f36; font-size:27px;">Birth</label>
				<div class="col-sm-6 ">
					<input type="text" name="birthyy" maxlength="4" placeholder="년(4자)" 	size="6" value="${year}" style="opacity:0.8;"> 
						...
						<option value=""style="font-family: 'Bebas Neue', cursive;color:#369f36; font-size:30px;">Month</option>
			...
			<div class="form-group  row">
				<div class="col-sm-12">
				<button class="btn" style="text-align:center; color:#369f36;  background-color:whitegray;" type="submit">Member Update</button>
				<button class="btn" style="text-align:center; color:#369f36;  background-color:whitegray;" type="button" onclick="location.href='deleteMember.jsp'">Member Delete</button>
				</div>
			</div>
		</form>	
	        </div>
